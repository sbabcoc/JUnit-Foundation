...
public class JUnitAgent {
    ...
    public static ClassFileTransformer installTransformer(Instrumentation instrumentation) {
        ...
        final Generic _void_ = TypeDescription.ForLoadedType.of(void.class).asGenericType();
        ...
        final SignatureToken runToken = new SignatureToken("run", TypeDescription.ForLoadedType.of(void.class), Arrays.asList(runNotifier));
        ...
        final SignatureToken createTestToken = new SignatureToken("createTest", TypeDescription.ForLoadedType.of(Object.class), Arrays.asList(frameworkMethod));
